      ...
      <SettingsProvider>
        <Routes>
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <RequirePermission slug="pixels.manage">
                  <AdminLayout><PixelsPage /></AdminLayout>
                </RequirePermission>
              </RequireAuth>
            }
          />
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <RequirePermission slug="profile.manage">
                  <AdminLayout><ProfilePage /></AdminLayout>
                </RequirePermission>
              </RequireAuth>
            }
          />
          <Route path="/admin/branding" element={<RequireAuth><RequirePermission slug="roles.manage"><AdminLayout><BrandingPage /></AdminLayout></RequirePermission></RequireAuth>} />
          <Route path="/admin/activity" element={<RequireAuth><RequirePermission slug="activities.manage"><AdminLayout><ActivityPage /></AdminLayout></RequirePermission></RequireAuth>} />
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <RequirePermission slug="integrations.manage">
                  <AdminLayout>
