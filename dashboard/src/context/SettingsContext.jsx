...
export function SettingsProvider({ children }) {
  ...
  useEffect(() => {
    ...
    if (theme.primary) root.style.setProperty('--su-primary', theme.primary);
    if (theme.primary) root.style.setProperty('--su-accent', theme.primary);
    if (theme.secondary) root.style.setProperty('--su-secondary', theme.secondary);
    if (theme.accent) root.style.setProperty('--su-link', theme.accent);
    ...
    if (theme.radius != null) root.style.setProperty('--su-radius', `${theme.radius}px`);
    if (theme.headingFont) root.style.setProperty('--su-heading-font', theme.headingFont);
    if (theme.bodyFont) root.style.setProperty('--su-body-font', theme.bodyFont);

    // --- Favicon ---
    const faviconUrl = settings?.faviconUrl || '/assets/logo.svg';
    ...
    const appIconUrl = settings?.appIconUrl || '/assets/logo.svg';
